...
import { BookMarked, History, ListCheck, Gamepad2, ChevronRight, Lock } from "lucide-react";
    ...
    <div className="min-h-screen bg-background py-6 px-4 md:px-0">
      <div className="max-w-4xl mx-auto space-y-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground font-body text-base mt-1">Nâng cao kỹ năng ngôn ngữ ký hiệu của bạn qua nhiều hình thức đa dạng.</p>
        </motion.div>
                    ...
                    <div className="flex h-full">
                      ...
                      <div className="p-6 flex flex-1 items-center justify-between">
                        <div className="flex items-center gap-5">
                          <div className={`w-14 h-14 rounded-2xl ${mode.color}/10 flex items-center justify-center text-white`}>
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground font-body line-clamp-1">{mode.description}</p>
                          </div>
                        </div>
